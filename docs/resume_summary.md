...
Results-driven Lead Software Developer with 14+ years architecting and delivering mission-critical, full-stack solutions in healthcare and enterprise environments. Expert in serverless cloud architecture, real-time systems, and platform modernization using Node.js, React, and AWS technologies. Proven track record of transforming legacy systems into scalable, high-performance solutions while leading engineering teams through complex technical transformations. Known for identifying and resolving critical security vulnerabilities, designing systems that serve 150+ concurrent users in healthcare settings, and delivering architectural solutions that reduce costs and improve performance by over 50 percent. Passionate about mentoring teams, implementing best practices, and driving innovation through thoughtful technical leadership.

## Technical Skills

- **Cloud & DevOps:** Amazon Web Services (AWS), AWS Lambda, API Gateway, CloudFormation, AWS Bedrock, AWS Lex, Serverless Framework, CI/CD, Caching, DevOps, GitHub Actions, CloudWatch, AWS Secrets Manager
- **Front-end:** React, React Native, Angular, HTML, CSS, JavaScript (ES6), Babel, Blockly
- **Back-end:** Node.js, Express.js, Microservices, REST APIs, JWT, Socket.IO
- **Data:** DynamoDB, Firebase/Firestore, MongoDB, NoSQL
- **Testing:** Jest
- **Security:** Encryption, JWT, HIPAA Compliance, Web Security Audits, Auth0, AWS Cognito
- **Collaboration:** Atlassian, Jira, Jira Service Desk, Confluence, Bitbucket
- **Integrations:** Zoho Bookings API, Twilio, AWS SNS, Serverless Stack (SST)
- **Other:** BPM, Mobile Apps, Webpack, Web Security, CloudFront, NextAuth
...
- Engineered robust notification system using AWS SNS and Twilio for SMS alerts on booking confirmations, reschedules, and cancellations.
